...
export function TagManager({ tags, token, visible, onCancel, onChanged }: TagManagerProps) {
  ...
  return <Modal animationType="none" onRequestClose={onCancel} transparent visible={visible}><View style={styles.drawerOverlay}><View style={styles.tagManagerDialog}>
